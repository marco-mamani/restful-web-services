package duo.code.rest.webservices.resfulwebservices;
...
public class SwaggerConfig {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact("Marco Mamani", "http://duo.code.com", "natmikhir@gmail.com");
